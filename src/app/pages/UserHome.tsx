...
import { Search, MapPin, Star, Clock, Users, Heart, ChevronDown } from 'lucide-react';
...
const UserHome: React.FC<UserHomeProps> = () => {
  ...
  // Filter services based on user interests
  const getFilteredServices = () => {
    ...
    if (userInterests.length > 0) {
      filtered = filtered.filter(service => 
        userInterests.includes(service.category)
      );
    }
                ...
                <div key={service.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                      <div>
                        <p className="text-3xl font-bold text-gray-900">${service.base_price}</p>

...
export default function ProviderAuthPage() {
  ...
  const checkUserRole = async () => {
    ...
    if (data?.role === 'service_provider' && data?.onboarding_completed) {
      router.push('/provider/dashboard')
    } else if (data?.role === 'service_provider' && !data?.onboarding_completed) {
      ...
      <div className="max-w-md mx-auto px-4 py-20">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Welcome Provider!</h2>
            <p className="text-gray-600 text-center mb-8">
              Sign in to list your services, manage bookings, and grow your tourism business
            </p>
